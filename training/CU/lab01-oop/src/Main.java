...
public class Main {
	...
	public static void removeDepartmentFromDatabase(int index) {
		ArrayList<GuildMember> members = myDatabase.removeDepartment(index);
		System.out.println("Department at index " + index + " is now removed.");

		myDatabase.getDepartment(0).addMultipleMembers(members);
		System.out.println(members + " are moved to the unassigned department.");
	}
